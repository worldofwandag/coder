...
import resumePDF from "../../assets/JonathanWandag-Resume-FullStack.pdf";
        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"Jonathan Wandag"} />
              </h2>
              <h4>
              ...
              >
                ...
                <a
                  href={resumePDF}
                  download="JonathanWandag-Resume-FullStack.pdf"
                  rel="noreferrer"
                >
                  <Icon img={fileIcon} />
                </a>
