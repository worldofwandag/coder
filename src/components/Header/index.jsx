...
import jwIcon from '../../assets/Images/jwlogo8bit-crop2.svg'
...
export default function Header() {
  ...
  return (
    <header ref={ref}>
      ...
      <NavMenu />
      <div className="background--button--glow"></div>
      <div className="background--glow--blue"></div>

      <motion.div initial="hidden" animate="visible" variants={blurVariants} transition={{ duration: 0.6, delay: 0.5 }} className="header--menuBtn">
        <Button icon={MenuIcon} onClick={handleMenuToggle} />
      </motion.div>

      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 0.7, delay: 0.5 }} className="header--top">
        <h3>
          <a href="https://github.com/worldofwandag" target={"_blank"} rel="noopener noreferrer" className="header--socials">
            <ScrambleText shuffle delay={1.8}>
              Github
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="https://linkedin.com/in/worldofwandag" target={"_blank"} rel="noopener noreferrer" className="header--socials">
            <ScrambleText shuffle delay={2.3}>
              LINKEDIN
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="/" target={"_blank"} rel="noopener noreferrer" className="header--socials">
            <ScrambleText shuffle delay={2}>
              RESUME
            </ScrambleText>
          </a>
        </h3>
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 4 }} className="header--bottom">
        <div>
          ...
          <p className="theme--detail">
            <ScrambleText shuffle delay={4}>
              HI!!! I’m Jonathan, I tackle complex engineering challenges daily, alongside a team of elite software engineers. My mission is to continuously advance in web development, using my growing expertise to drive societal progress through technology.
            </ScrambleText>
          </p>
        </div>
